package ng.com.silveredgeprojects.nearbyshop.ShopItemByShop.ItemCategories;
...
public class ItemCategoriesAdapter extends RecyclerView.Adapter<ItemCategoriesAdapter.ViewHolder>{
    ...
    private ItemCategoriesFragmentShopHome activity;
    ...
    public ItemCategoriesAdapter(List<ItemCategory> dataset, Context context, ItemCategoriesFragmentShopHome activity,
