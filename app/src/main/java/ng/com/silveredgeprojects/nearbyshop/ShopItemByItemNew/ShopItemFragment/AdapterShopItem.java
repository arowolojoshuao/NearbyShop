package ng.com.silveredgeprojects.nearbyshop.ShopItemByItemNew.ShopItemFragment;
...
public class AdapterShopItem extends RecyclerView.Adapter<AdapterShopItem.ViewHolder>{
    ...
    public AdapterShopItem(List<ShopItem> dataset, Context context, Item item, NotifyFilledCart notifyFilledCart) {
