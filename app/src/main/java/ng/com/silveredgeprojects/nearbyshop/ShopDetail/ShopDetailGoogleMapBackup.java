package ng.com.silveredgeprojects.nearbyshop.ShopDetail;//package org.nearbyshops.enduserappnew.ShopDetail;
//
...
//
//public class ShopDetailGoogleMapBackup extends AppCompatActivity implements Target, RatingBar.OnRatingBarChangeListener ,NotifyReviewUpdate, OnMapReadyCallback {
//
...
//
//
//    public ShopDetailGoogleMapBackup() {
//
...
//
//                                String imagePath = PrefGeneral.getImageEndpointURL(ShopDetailGoogleMapBackup.this)
...
//                                                R.drawable.ic_nature_people_white_48px, getTheme());
//
//                                Picasso.with(ShopDetailGoogleMapBackup.this).load(imagePath)
//                                        .placeholder(placeholder)
